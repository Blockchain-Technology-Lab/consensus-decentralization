...
def main(projects, timeframes, force_parse, force_map, entropy_alpha, make_plots, output_dir=OUTPUT_DIR):
    """
...
if __name__ == '__main__':
    ...
    main(projects, timeframes, args.force_parse, args.force_map, args.entropy_alpha, args.plot)
