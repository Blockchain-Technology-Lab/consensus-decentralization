...
def test_ethereum_aggregation(setup_and_cleanup, mock_sample_ethereum_mapped_data):
    ...
    aggregate(project='sample_ethereum', output_dir=test_io_dir, timeframes=timeframes, force_aggregate=True)
...
def test_cardano_aggregation(setup_and_cleanup, mock_sample_cardano_mapped_data):
    ...
    aggregate(project='sample_cardano', output_dir=test_io_dir, timeframes=timeframes, force_aggregate=True)
...
def test_tezos_aggregation(setup_and_cleanup, mock_sample_tezos_mapped_data):
    ...
    aggregate(project='sample_tezos', output_dir=test_io_dir, timeframes=timeframes, force_aggregate=True)
